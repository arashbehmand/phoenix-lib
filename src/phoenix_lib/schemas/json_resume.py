# Canonical JSON Resume v1.0.0 Pydantic models.
# Generated from resume.schema.json; extended with LangChain parser helpers.
#
# Both phoenix-job-assistant and phoenix-resume-renderer previously maintained
# independent copies of these models.  This is the single source of truth.
...
class EducationItem(BaseModel):
    ...
    courses: list[str] | None = Field(None, description="List notable courses/subjects")
...
class ResumeSchema(BaseModel):
    ...
    projects: list[Project] | None = Field(None, description="Specify career projects")
...
def get_json_resume_format_instructions() -> str:
    """Return LLM format instructions for generating a valid JSON Resume."""
    return get_json_resume_parser().get_format_instructions()
...
__all__ = [
    ...
    "Work",
    "WorkItem",
    "get_json_resume_format_instructions",
    "get_json_resume_parser",
]
